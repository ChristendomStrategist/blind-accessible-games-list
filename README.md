...
- [Balatro](https://store.steampowered.com/app/2379780/Balatro/) (PC, with [the Black Hole mod](https://github.com/Aurelius7309/BlackHole)) - fully accessible
...
- [Disco Elysium](https://store.steampowered.com/app/632470/Disco_Elysium__The_Final_Cut/) (PC, with [the Disco Accessibility mod](https://github.com/BlindGuyNW/disco-accessibility), download separately available [here](https://www.dropbox.com/scl/fo/5tpn0fdadkgb76ujprr8k/AItJ_UbPp2cMR3ctbJ2jAvE?rlkey=ma5zvumvumwhytbsr424eo5un&dl=1)) - fully accessible, requires both controller and keyboard, navigation needs some getting used to
...
- [Doom + Doom II](https://store.steampowered.com/app/2280/DOOM__DOOM_II/), [Heretic](https://store.steampowered.com/app/2390/Heretic_Shadow_of_the_Serpent_Riders/) & [Hexen](https://store.steampowered.com/app/2360/Hexen_Beyond_Heretic/) (PC, with [the Toby Doom Accessibility mod](https://alando1.itch.io/)) - limited information
...
- [Escape from Norwood](https://store.steampowered.com/app/2372150/Escape_from_Norwood/) (PC/Android/iOS) - fully accessible
...
- [Football Manager 26](https://store.steampowered.com/app/3551340/Football_Manager_26/) (PC, with [the FM26 Access mod](https://github.com/GreenBeanGravy/FM26Access/)) - work in progress, under active development
...
- [Minecraft: Java Edition](https://www.minecraft.net/en-us/store/minecraft-java-bedrock-edition-pc) (PC, with [the Minecraft Access mod](https://mcaccess.org)) - playable, requires decent spatial awareness
...
- Most games made in [Ren'Py](https://www.renpy.org/) e.g. [Doki Doki Literature Club](https://store.steampowered.com/app/698780/Doki_Doki_Literature_Club/), [Slay the Princess](https://store.steampowered.com/app/1989270/Slay_the_Princess/) ... (PC, sometimes with a mod) - fully accessible
...
- Red & Black (PC) - playable, accessibility features can be a bit tedious to use
...
- [The Elder Scrolls V: Skyrim Anniversary Edition](https://store.steampowered.com/sub/626153/) (PC, with [the Skyrim Access mod](https://gitlab.com/SkyrimAccessibilityProject/SkyrimAccessMod)) - work in progress, under active development
...
- Zelda 1 (emulated on PC, with [the Zelda1Access mod](https://github.com/gadeuvall2000/zelda1access)) - fully accessible
...
- [BitLife](https://apps.apple.com/us/app/bitlife-life-simulator/id1374403536) Dogs - fully accessible
...
## Game-link checks still worth doing

I added direct game/store/official links where there was a reasonably clear target. I left these unlinked or only partially handled because the exact target is ambiguous, unavailable on a current storefront, a ROM/emulation case, a broad series bucket, or needs manual confirmation before submitting upstream:

- Dragon Warrior 1 (emulated on PC, with [the Dragon Warrior Access mod](https://github.com/GADeuvall2000/DragonWarriorAccess))
- Fire Emblem Sacred Stones (PC, with [this mod](https://github.com/StanHash/GBA-Fire-Embem-for-Screen-Readers))
- Red & Black (PC)
- Zelda 1 (emulated on PC, with [the Zelda1Access mod](https://github.com/gadeuvall2000/zelda1access))
- Academy of Disaster
- Adventure to Fate (full series) – fully accessible
- Art of Fauna – fully accessible
- Art of Flora – fully accessible
- Baby Adopter and spinoffs
- BattleCry
- Eldrum: all games in the series
- Galactic Colonies – fully accessible
- Idle Crafting Kingdom
- Invisible Dragons – fully accessible
- Lords and Knights (and spinoffs)
- Six Ages 1 and 2
